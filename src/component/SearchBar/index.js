...
export default props => {
    ...
    return (
        <Box p={2} mt={-5} mb={2} className={classes.wrapper}>
            <Select onClick={handleChange} value={jobSearch.type} name="type" variant="filled" disableUnderline>
                <MenuItem value="Full Time">Full Time</MenuItem>
                <MenuItem value="Part Time">Part Time</MenuItem>
                <MenuItem value="Intern">Intern</MenuItem>
            </Select>
            <Select onClick={handleChange} value={jobSearch.location} name="location" variant="filled" disableUnderline>
